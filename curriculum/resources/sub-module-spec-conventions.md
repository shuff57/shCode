...
environment: moSHion         # or "console", "html-css", etc.
slos:
...
| `Section` | yes | URL or chapter pointer (e.g. `/docs/moshion` for the in-app docs) |
...
```markdown
### `lessons/moshion-groups/` → `lessons/2-3-5-groups-sandbox/`
