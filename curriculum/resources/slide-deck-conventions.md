...
**Scaffold discipline:** show **conceptual** code in slides, not the graded-lab solution. Per `sketch-lesson-conventions.md` (or the unit's equivalent starter doc), the graded starter is a scaffold; don't put the solution on a slide.
