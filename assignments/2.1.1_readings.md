...
**Important to know:** **freeCodeCamp JavaScript v9 does not cover q5.js, q5play, or any game development.** Its curriculum stops at general JavaScript and algorithms. That's why this module's primary reference is the in-app q5play docs, not an external platform.

**This is expected, not a gap.** The q5play docs ARE the textbook for this module.

### FCC material that reinforces THIS module

Even though the platform doesn't cover q5play directly, several of its lessons strengthen the underlying JS skills you're using this week. These are **reference only** — not required reading.
...
**Remember:** your teacher didn't pick freeCodeCamp because it teaches q5play. It was chosen because it teaches the JavaScript foundations that make q5play possible. You already learned those in Q1 — now you're applying them.
