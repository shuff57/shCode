...
## Primary reading — in-app shplay docs

The course platform hosts the complete shplay docs at:

**[/docs/shplay](/docs/shplay)** (open in the same browser window you use for lessons)
...
shplay is built on top of **q5.js**, a lightweight reimplementation of p5.js focused on performance. If you're curious about the engine underneath:
...
- Any "Hello world in p5.js" tutorial will work for shplay; the only real difference is that shplay adds the `Sprite` / `Group` / `world` physics layer on top.
...
**Important to know:** **freeCodeCamp JavaScript v9 does not cover q5.js, shplay, or any game development.** Its curriculum stops at general JavaScript and algorithms. That's why this module's primary reference is the in-app shplay docs, not an external platform.

**This is expected, not a gap.** The shplay docs ARE the textbook for this module.

### FCC material that reinforces THIS module

Even though the platform doesn't cover shplay directly, several of its lessons strengthen the underlying JS skills you're using this week. These are **reference only** — not required reading.
...
- FCC HTML/CSS certifications — shplay doesn't use page layout
...
| **[Box2D Documentation](https://box2d.org/documentation/)** | Physics engine used by shplay | Advanced only — W11 physics module references specific concepts |

**Remember:** your teacher didn't pick freeCodeCamp because it teaches shplay. It was chosen because it teaches the JavaScript foundations that make shplay possible. You already learned those in Q1 — now you're applying them.
