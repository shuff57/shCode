...
**Module resources:**
- 📋 [Module overview](5.1_overview.md) — recommended learning order
- 📖 [Readings](5.1_readings.md) — moSHion docs + FCC refs
- 💡 [Worked examples](5.1_worked-examples.md) — reference code from class walkthroughs
- ⭐ [Challenges](5.1_challenges.md) — stretch problems if you finish early
