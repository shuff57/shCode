...
- Read the "Canvas & Sprite" and "Input" chapters of the shplay docs (see [readings](2.1.1_readings.md)).
...
### Question 1 (2 pts)
In your own words, what is the difference between `setup()` and `draw()` in a shplay sketch? When does each one run?

### Question 2 (2 pts)
shplay runs at about **60 frames per second** (60 fps).
