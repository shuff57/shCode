...
- Read the "Canvas & Sprite" and "Input" chapters of the moSHion docs (see [readings](5.1_readings.md)).
...
**Other 2.1.1 resources:** [overview](5.1_overview.md) · [worked examples](5.1_worked-examples.md) · [challenges](5.1_challenges.md)
