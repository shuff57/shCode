...
export default function SketchConstraints({ points, constraints, onChange }: Props) {
  ...
  return (
    <div className="sk-rules">
      ...
      <style>{`
        ...
        .sk-pins { display: flex; align-items: center; gap: 4px; margin-top: 8px; color: #6272a4; }
      `}</style>
    </div>
  );
}
