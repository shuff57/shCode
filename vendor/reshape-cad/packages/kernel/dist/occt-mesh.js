 ...
 */
export function tessellate(oc, shape, opts = {}) {
    ...
    for (const f of facesOf(oc, shape)) {
        ...
        if (!tri || (typeof tri.IsNull === 'function' && tri.IsNull()))
            continue;
        if (typeof tri.NbTriangles !== 'function' || tri.NbTriangles() === 0)
            continue;
...
//# sourceMappingURL=occt-mesh.js.map