...
export const BLOCKING = ['unbound', 'absent'];
export function isBlocking(s) {
 ...
 */
export function blockedNames(names) {
 ...
 */
export function whyNotPortable(names) {
...
//# sourceMappingURL=script-surface.js.map