...
## AP CSP Discussion: Digital Information (Unit 8)

Curriculum plan integration: W2 (binary), W8 (compression), W11 (image representation)
...
## AP CSP Discussion: The Internet (Unit 11)

Curriculum plan integration: W10 (HTTP, DNS, client-server), W11 (TCP/IP, fault tolerance), W23 (cybersecurity)
...
## AP CSP Discussion: Steganography (Unit 9)

Curriculum plan note: Unit 9 is not integrated into CSCI 4 (requires image manipulation). Listed for reference only.
...
## AP CSP Discussion: Data (Unit 13)

Curriculum plan integration: W19 (metadata), W22 (parallel computing)
...
| W6 | 8 |
| W8 | 14 |
| W22 | 2 (cross-listed from W8) |
| AP CSP: Digital Information (Unit 8) | 21 |
| AP CSP: The Internet (Unit 11) | 3 |
| AP CSP: Steganography (Unit 9) | 1 |
| AP CSP: Data (Unit 13) | 3 |
| Unassigned | 20 |
| **Total** | **103** unique (+ 2 cross-listed under W22) |

Note: FCC does not use the [Example] tag. FCC content is organized as [Theory], [Workshop], and [Lab] items, which are tracked separately in the master activity list.
