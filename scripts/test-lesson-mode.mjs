// Runs scripts/lesson-mode-assertions.cjs against lib/lesson-mode.ts.
//
...
const out = mkdtempSync(path.join(tmpdir(), 'shcode-mode-'));
...
try {
  ...
  const ok = require('./lesson-mode-assertions.cjs')(out.replace(/\\/g, '/'));
