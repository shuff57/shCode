// Runs scripts/pii-check-assertions.cjs against lib/pii-check.ts.
//
...
const out = mkdtempSync(path.join(tmpdir(), 'shcode-pii-'));
...
try {
  ...
  const ok = require('./pii-check-assertions.cjs')(out.replace(/\\/g, '/'));
