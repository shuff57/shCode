...
// The limit never changes, so it is a const rather than a let.
// $2.00 a slice is the bar the assignment sets.
const goodDealLimit = 2.0;
...
const meetsTheLimit = costPerSlice <= goodDealLimit;
...
console.log(`The limit we set was $${goodDealLimit.toFixed(2)} a slice.`);
