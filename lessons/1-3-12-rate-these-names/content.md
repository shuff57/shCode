...
| # | Criterion |
|---|-----------|
| 1 | All six names are judged |
| 2 | Each reason names the rule, not just the verdict |
| 3 | Q7: identifies the borderline name and says what makes it arguable |
| 4 | Q8: the four names are matched to their problems |
