...
**Read after `2.7.4 Reading — q5play docs: mouse.pressing()`.** About 5 minutes.
...
**What you'll see:** one sprite per click, no matter how long you hold. The background clears each frame, but sprites persist because q5play keeps them in the world until deleted.
