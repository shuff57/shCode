...
Read this before `6.2.5 Worked Example — Safe Despawn`. About 6 minutes.
...
Once you can explain why the callback form is the safe place to call `delete()`, open `6.2.5 Worked Example — Safe Despawn`.
