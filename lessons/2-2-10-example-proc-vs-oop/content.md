...
## Worked Example — Two solutions to the same problem
...
### Approach A — Procedural with parallel arrays
...
### Approach B — OOP with an array of instances
...
## Which would you rather extend?

Think through these before your A12.2 written reflection — no answer key:

1. You want to add an `element` property to each enemy (fire, ice, lightning). In Approach A, how many arrays do you touch? In Approach B, how many lines inside the class do you touch?
2. In Approach A, deleting enemy at index 3 means four aligned operations. What happens if you forget one? In Approach B, what is the equivalent operation?
