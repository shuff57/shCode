...
Every q5play sketch needs a canvas — the rectangular drawing area where sprites appear. You create one with `new Canvas(width, height)` on the first line of `setup()`.
