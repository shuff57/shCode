...
- The eighth, `object`, holds collections. It gets its own lesson (1.2.23).
...
Notice the last one. `notSetYet` was declared and never given a value, and it still printed something. That is a type too — and it has its own lesson at 1.2.21.
