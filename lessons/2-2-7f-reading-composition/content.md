...
- Composition gives you a clear boundary: `this.sprite` is the q5play API surface. Everything outside `this.sprite` is your class's own logic.
...
**What you'll see:** a red square with HP text below it. `e` is your `Enemy`; the sprite is a tool it holds. You access the sprite via `e.sprite.color`, `e.sprite.x`, etc. — you always know you're in q5play territory the moment you see `.sprite.`.
