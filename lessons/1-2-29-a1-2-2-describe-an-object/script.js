...
//         (see lesson 1.2.3 for how each one is written)

// STEP 3: print ONE sentence describing the object, using a
//         template literal (backticks) with your variables
//         embedded in it.

// STEP 4: log the typeof at least one number, one string and one
//         boolean, to confirm each holds what you meant it to.
