...
**Read before attempting `2.7.19 Worked Example — Launch a Sprite with applyForce`.**
...
This is pure math — no special q5play function needed beyond reading `.pos.x` and `.pos.y`.
