...
A **sprite** is a visible, physics-aware rectangle that shplay draws for you every frame. You create one with `new Sprite(x, y, width, height)` and the engine takes care of rendering it automatically.
...
- You do **not** call any render method; shplay draws the sprite for you each frame.
...
**What you'll see:** a default-colored square centred in a dark-grey canvas. shplay drew it for you — you never called any render function.
...
| Term | Meaning |
|------|---------|
| **Sprite** | A visible, physics-aware rectangle shplay draws for you every frame. |
